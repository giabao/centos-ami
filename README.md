...
Requirements?
@see http://www.idevelopment.info/data/AWS/AWS_Tips/AWS_Management/AWS_10.shtml#CentOS%20Build%20Machine
...
4. Use putty (I use MS Windows) to connect to VM, run:
...
(use winscp) upload 2 X.509 Certificates (.pem) file to /tmp/cert
...
e. mount the image file to a directory
...
g. install CentOS minimal to the image
mkdir -p /opt/ec2/yum
...
______________________
yum -c /opt/ec2/yum/yum-xen.conf --installroot=/mnt/ec2-image install <packages from step 4.a>
